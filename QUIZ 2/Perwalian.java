public class Perwalian extends Mahasiswa {
    private MataKuliah[] mataKuliahArray;
    private int jumlahMataKuliah;

    public Perwalian(String nama, String nim, double[] nilai, int maxMataKuliah) {
    ...
    public String toString() {
        return "Perwalian [nama=" + getNama() + ", nim=" + getNim() + "]";
    }
}
