public class Main {
    public static void main(String[] args) {
        ...
        Perwalian mahasiswa1 = new Perwalian("Silfi Nazarina", "2241720054", new double[]{80, 85, 90}, 5);
        Perwalian mahasiswa2 = new Perwalian("Doh Kyungsoo", "789012", new double[]{90, 88, 92}, 5);

        // Membuat objek mata kuliah
        MataKuliah mataKuliah1 = new MataKuliah("GUI", 3, 10);
